...
function get_all_products(){
	global $db;
	$get_pro="select * from products ORDER BY 1 DESC LIMIT 0,20";
	...
	<div class='product'style='width: 270px; height: 500px; box-sizing: border-box;'>
...
while($row_pro=mysqli_fetch_array($run_pro)){
    ...
    $pro_img1=$row_pro['product_img1'];
     ...
     echo "
			...
			<div class='product'style='width: 280px; height: 450px; box-sizing: border-box;'>
				...
				<div class='text'>
					...
					<p class='buttons'style='margin-left: 20px; margin-top:30px;'>
						...
						<a href='details.php?pro_id=$pro_id' class='btn btn-primary'style='margin-left:72px; margin-top: -11px;'><i class='fa fa-shopping-cart'></i>Add to cart</a>
					</p>
				</div> <!-- text -->
...
function getspecificpcats(){
	global $db;
	if(isset($_GET['p_cat'])){
		$p_cat_id=$_GET['p_cat'];
		$get_cat="select * from product_cateogries WHERE p_cat_id='$p_cat_id'";
