...
<div class="box" style="padding-bottom: 60px;">
	<div class="box-header">
		<center>
			<h2>Contact Us</h2>
			<p class="text-muted">If you have any Questions, please feel free to contact us , our customer services center is working for you 24/7.</p>
		</center>
	</div> <!-- box header -->
...
<button  style="margin-left:300px; margin-top: 7px;" type="submit"  name="submit" class="btn btn-primary text-center"><i style="margin-right: 10px; font-weight: bold;" class="fa fa-user-md "></i>Send message</button>
       ...
       $sender_name=$_POST['name'];
        $sender_email=$_POST['email'];
         $sender_subject=$_POST['subject'];
          ...
          $reciver_email="sabapervaz991@gmail.com";
          mail($reciver_email, $sender_name,$sender_subject, $sender_message, $sender_email);
          
          // Customers mail//////////////
          $admin_email=$_POST['email'];
          $admin_subject="Welcome to our website";
          $admin_message="I'll get you soon , Thanks for sending email";
          $from="sabapervaz991@gmail.com";
          mail( $admin_email,$admin_subject, $admin_message,$from);
